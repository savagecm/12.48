...
public:
    static UBYTE EPD_12in48B_Init(void)
    {
        ...
        piDriver::getInstance()->DEV_Digital_Write(EPD_S2_CS_PIN, 1);
    ...
    static void EPD_12in48B_Clear(void)
    {
        UWORD y, x;
...
******************************************************************************/
    ...
    {
        piDriver::getInstance()->DEV_Digital_Write(EPD_M1S1_RST_PIN, 1);
        piDriver::getInstance()->DEV_Digital_Write(EPD_M2S2_RST_PIN, 1);
        piDriver::getInstance()->DEV_Delay_ms(200);
        piDriver::getInstance()->DEV_Digital_Write(EPD_M1S1_RST_PIN, 0);
        piDriver::getInstance()->DEV_Digital_Write(EPD_M2S2_RST_PIN, 0);
        piDriver::getInstance()->DEV_Delay_ms(10);
        piDriver::getInstance()->DEV_Digital_Write(EPD_M1S1_RST_PIN, 1);
        piDriver::getInstance()->DEV_Digital_Write(EPD_M2S2_RST_PIN, 1);
        piDriver::getInstance()->DEV_Delay_ms(200);
    }
...
******************************************************************************/
    ...
    {
        piDriver::getInstance()->DEV_Digital_Write(EPD_M1S1_DC_PIN, 0);
        piDriver::getInstance()->DEV_Digital_Write(EPD_M1_CS_PIN, 0);
        piDriver::getInstance()->DEV_SPI_WriteByte(Reg);
        piDriver::getInstance()->DEV_Digital_Write(EPD_M1_CS_PIN, 1);
    }
    static void EPD_M1_SendData(UBYTE Data)
    {
        piDriver::getInstance()->DEV_Digital_Write(EPD_M1S1_DC_PIN, 1);
        piDriver::getInstance()->DEV_Digital_Write(EPD_M1_CS_PIN, 0);
        piDriver::getInstance()->DEV_SPI_WriteByte(Data);
        piDriver::getInstance()->DEV_Digital_Write(EPD_M1_CS_PIN, 1);
    }
    ...
    {
        piDriver::getInstance()->DEV_Digital_Write(EPD_M1S1_DC_PIN, 0);
        piDriver::getInstance()->DEV_Digital_Write(EPD_S1_CS_PIN, 0);
        piDriver::getInstance()->DEV_SPI_WriteByte(Reg);
        piDriver::getInstance()->DEV_Digital_Write(EPD_S1_CS_PIN, 1);
    }
    ...
    {
        piDriver::getInstance()->DEV_Digital_Write(EPD_M2S2_DC_PIN, 0);
        piDriver::getInstance()->DEV_Digital_Write(EPD_M2_CS_PIN, 0);
        piDriver::getInstance()->DEV_SPI_WriteByte(Reg);
        piDriver::getInstance()->DEV_Digital_Write(EPD_M2_CS_PIN, 1);
    }
    static void EPD_M2_SendData(UBYTE Data)
    {
        piDriver::getInstance()->DEV_Digital_Write(EPD_M2S2_DC_PIN, 1);
        piDriver::getInstance()->DEV_Digital_Write(EPD_M2_CS_PIN, 0);
        piDriver::getInstance()->DEV_SPI_WriteByte(Data);
        piDriver::getInstance()->DEV_Digital_Write(EPD_M2_CS_PIN, 1);
    }
    ...
    {
        piDriver::getInstance()->DEV_Digital_Write(EPD_M2S2_DC_PIN, 0);
        piDriver::getInstance()->DEV_Digital_Write(EPD_S2_CS_PIN, 0);
        piDriver::getInstance()->DEV_SPI_WriteByte(Reg);
        piDriver::getInstance()->DEV_Digital_Write(EPD_S2_CS_PIN, 1);
    }
    ...
    {
        piDriver::getInstance()->DEV_Digital_Write(EPD_M1S1_DC_PIN, 0); // command write
        piDriver::getInstance()->DEV_Digital_Write(EPD_M2S2_DC_PIN, 0); // command write
    ...
    {
        piDriver::getInstance()->DEV_Digital_Write(EPD_M1S1_DC_PIN, 1); // command write
        piDriver::getInstance()->DEV_Digital_Write(EPD_M2S2_DC_PIN, 1); // command write
...
******************************************************************************/
    static void EPD_M1_ReadTemperature(void)
    {
        ...
        piDriver::getInstance()->DEV_Digital_Write(EPD_M1S1_DC_PIN, 1);
        piDriver::getInstance()->DEV_Delay_us(5);

        UBYTE temp;
        temp = piDriver::getInstance()->DEV_SPI_ReadByte(0x00);
        piDriver::getInstance()->DEV_Digital_Write(EPD_M1_CS_PIN, 1);
